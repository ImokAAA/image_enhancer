...
class LogInTest(TestCase):
	...
	def setUp(self):
		""" This method creates the 'c' Client and the user records in the database that will be used in further methods to check the login function """
	...
	def test_correct(self):
		...
		response = self.c.post('/users/login/', {'username': 'test', 'password': '12test12'})
	...
	def test_wrong_username(self):
		...
		response = self.c.post('/users/login/', {'username': 'wrong', 'password': '12test12'})
		user = auth.get_user(self.client)
